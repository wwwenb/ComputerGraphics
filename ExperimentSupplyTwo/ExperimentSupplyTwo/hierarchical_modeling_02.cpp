...
head()
{
	...
	mat4 instance = (Translate(0, 0.5 * HEAD_HEIGHT, 0)*
...
{
	mvstack.push(model_view);
	mat4 instance = (Translate(0.5*UPPER_ARM_WIDTH, 0.5*UPPER_ARM_HEIGHT, 0)*
...
{
	mvstack.push(model_view);
	mat4 instance = (Translate(0.5*LOWER_ARM_WIDTH, 0.5 * LOWER_ARM_HEIGHT, 0) *
...
{
	mvstack.push(model_view);
	mat4 instance = (Translate(0.5 *UPPER_LEG_WIDTH, 0.5 * UPPER_LEG_HEIGHT, 0) *
...
{
	mvstack.push(model_view);
	mat4 instance = (Translate(0.5 * LOWER_LEG_WIDTH, 0.5 * LOWER_LEG_HEIGHT, 0) *
...
display()
{
	...
	mvstack.push(model_view);
	model_view *= (Translate(0, TORSO_HEIGHT, 0)*
		 RotateZ(theta[Head1]));
	head();
	model_view = mvstack.pop();

	mvstack.push(model_view);
	model_view *= (Translate(0.5 * TORSO_WIDTH, TORSO_HEIGHT, 0) *
		RotateX(theta[LeftLowerArm]));
	left_lower_arm();
	model_view *= (Translate(0, LOWER_ARM_HEIGHT , 0) *
	...
	mvstack.push(model_view);
	model_view *= (Translate(0.5 * TORSO_WIDTH, 0, 0) *
