...
void mainWindowMenuEvents(int menuChoice)
{
	...
	case MENU_START_ANIMATION:
		glutIdleFunc(idleFunction);
		break;
	case MENU_STOP_ANIMATION:
		glutIdleFunc(NULL);
		break;
	}
...
void mainWindowSetupMenu()
{
	...
	glutAddMenuEntry("Start Animation", MENU_START_ANIMATION);
	glutAddMenuEntry("Stop Animation", MENU_STOP_ANIMATION);
